...
/// </summary>
[SuppressMessage("Style", "IDE0060:Remove unused parameter", Justification = "All parameters specified are required by HarmonyLib.")]
...
public static class Game1_IsActiveNoOverlay_Patch {
  ...
  public static bool Prefix(Game1 __instance, ref bool __result) {
    ...
    if (Program_sdk is not null && ModEntry.Config.DisableGamePause && !ModEntry.IsSaveLoaded && !Program_sdk.HasOverlay) {
      __result = true;
      return false;
    }

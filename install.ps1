...
#>
  ...
  [Process] $DotNetProcess = (Start-Process -NoNewWindow -FilePath $DotNet -Wait -ArgumentList @('build', $ModCsProj, "-property:Configuration=$($Configuration)", "-property:SolutionDir=$($Configuration)") -PassThru);
